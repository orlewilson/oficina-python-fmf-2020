'''
	...
	Data:           17/11/2020
	Nome:           Seu nome
	Descrição:      exemplo de analisador de pacotes usando python
	Fonte:			https://vnetman.github.io/pcap/python/pyshark/scapy/libpcap/2018/10/25/analyzing-packet-captures-with-python-part-1.html
...
# execução do código
# python ex-pcap.py --pcap example-01.pcap